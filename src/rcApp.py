...
class Dialog(QDialog):
    ...
    def createFormGroupBox(self):
        ...
        self.start_price = QLineEdit()
        self.start_price.textEdited.connect(self.make_saveTextEdit(3))
        self.leverage = QLineEdit()
        self.leverage.textEdited.connect(self.make_saveTextEdit(4))
        self.main_mar_rate = QLineEdit()
        self.main_mar_rate.textEdited.connect(self.make_saveTextEdit(5))
    ...
    def calculate_trade(self):
        try:
            ...
            if self.long_short:
                ...
                short_return_string = cal.calc_short_trade(bal, ft, sp, lev, mmr)
